                                    ...
                                    value = """
                                            {
                                                ...
                                                "status": 403,
                                                "type": "http://localhost:8080/api/inventorycontrol/store/create",
            ...
            @ApiResponse(
                    ...
                    content = @Content(
                            ...
                            examples = @ExampleObject(
                                    value = """
                                            {
                                                 "path": "http://localhost:8080/api/inventorycontrol/store/create",
                                    ...
                                    value = """
                                            {
                                                 ...
                                                 "status": 404,
                                                 "type": "http://localhost:8080/api/inventorycontrol/store/update/{uuid}",
            ...
            @ApiResponse(
                    ...
                    content = @Content(
                            ...
                            examples = @ExampleObject(
                                    value = """
                                            {
                                                 "path": "http://localhost:8080/api/inventorycontrol/store/update/{uuid}",
                                                 "message": "The Token has expired on Mon May 23 17:39:42 BRT 2022.",
                                                 "error": "Unauthorized",
                                                 "status": 401
                                            }
                                    ...
                                    value = """
                                            {
                                                "timestamp": "23-05-2022 17:38:25",
                                                "status": 403,
                                                "type": "http://localhost:8080/api/inventorycontrol/store/findAll",
                                                "title": "Não autorizado.",
                                                "detail": "Usuário não tem permissão para acessar esse recurso!"
                                            }
                                            """
            ...
            @ApiResponse(
                    ...
                    content = @Content(
                            ...
                            examples = @ExampleObject(
                                    value = """
                                            {
                                                 "path": "http://localhost:8080/api/inventorycontrol/store/findAll",
                                                 "message": "The Token has expired on Mon May 23 17:39:42 BRT 2022.",
                                                 "error": "Unauthorized",
                                                 "status": 401
                                            }
                                    ...
                                    value = """
                                            {
                                                 "timestamp": "",
                                                 "status": 404,
                                                 "type": "http://localhost:8080/api/inventorycontrol/store/findById/{uuid}",
                                                 "title": "Recurso não encontrado.",
                                                 "detail": "Loja não está armazenada no sistema."
                                            }
                                            """
            ...
            @ApiResponse(
                    ...
                    content = @Content(
                            ...
                            examples = @ExampleObject(
                                    value = """
                                            {
                                                 "path": "http://localhost:8080/api/inventorycontrol/store/findById/{uuid}",
                                                 "message": "The Token has expired on Mon May 23 17:39:42 BRT 2022.",
                                                 "error": "Unauthorized",
                                                 "status": 401
                                            }
                                    ...
                                    value = """
                                            {
                                                 "timestamp": "23-05-2022 11:56:30",
                                                 "status": 404,
                                                 "type": "http://localhost:8080/api/inventorycontrol/store/delete/{uuid}",
                                                 "title": "Recurso não encontrado.",
            ...
            @ApiResponse(
                    ...
                    content = @Content(
                            ...
                            examples = @ExampleObject(
                                    value = """
                                            {
                                                 "path": "http://localhost:8080/api/inventorycontrol/store/delete/{uuid}",
                                                 "message": "The Token has expired on Mon May 23 17:39:42 BRT 2022.",
                                                 "error": "Unauthorized",
                                                 "status": 401
                                            }
