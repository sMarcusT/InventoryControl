                                    ...
                                    value = """
                                            {
                                                ...
                                                "status": 403,
                                                "type": "http://localhost:8080/api/inventorycontrol/entry_item/create",
            ...
            @ApiResponse(
                    ...
                    content = @Content(
                            ...
                            examples = @ExampleObject(
                                    value = """
                                            {
                                                 "path": "http://localhost:8080/api/inventorycontrol/entry_item/create",
                                    ...
                                    value = """
                                            {
                                                 ...
                                                 "status": 404,
                                                 "type": "http://localhost:8080/api/inventorycontrol/entry_item/update/{uuid}",
            ...
            @ApiResponse(
                    ...
                    content = @Content(
                            ...
                            examples = @ExampleObject(
                                    value = """
                                            {
                                                 "path": "http://localhost:8080/api/inventorycontrol/entry_item/update/{uuid}",
                                                 "message": "The Token has expired on Mon May 23 17:39:42 BRT 2022.",
                                                 "error": "Unauthorized",
                                                 "status": 401
                                            }
                                    ...
                                    value = """
                                            {
                                                "timestamp": "23-05-2022 17:38:25",
                                                "status": 403,
                                                "type": "http://localhost:8080/api/inventorycontrol/entry_item/findAll",
                                                "title": "Não autorizado.",
                                                "detail": "Usuário não tem permissão para acessar esse recurso!"
                                            }
                                            """
            ...
            @ApiResponse(
                    ...
                    content = @Content(
                            ...
                            examples = @ExampleObject(
                                    value = """
                                            {
                                                 "path": "http://localhost:8080/api/inventorycontrol/entry_item/findAll",
                                                 "message": "The Token has expired on Mon May 23 17:39:42 BRT 2022.",
                                                 "error": "Unauthorized",
                                                 "status": 401
                                            }
                                    ...
                                    value = """
                                            {
                                                 "timestamp": "",
                                                 "status": 404,
                                                 "type": "http://localhost:8080/api/inventorycontrol/entry_item/findById/{uuid}",
                                                 "title": "Recurso não encontrado.",
                                                 "detail": "Item de entrada não está armazenado no sistema."
                                            }
                                            """
            ...
            @ApiResponse(
                    ...
                    content = @Content(
                            ...
                            examples = @ExampleObject(
                                    value = """
                                            {
                                                 "path": "http://localhost:8080/api/inventorycontrol/entry_item/findById/{uuid}",
                                                 "message": "The Token has expired on Mon May 23 17:39:42 BRT 2022.",
                                                 "error": "Unauthorized",
                                                 "status": 401
                                            }
                                    ...
                                    value = """
                                            {
                                                 "timestamp": "23-05-2022 11:56:30",
                                                 "status": 404,
                                                 "type": "http://localhost:8080/api/inventorycontrol/entry_item/delete/{uuid}",
                                                 "title": "Recurso não encontrado.",
            ...
            @ApiResponse(
                    ...
                    content = @Content(
                            ...
                            examples = @ExampleObject(
                                    value = """
                                            {
                                                 "path": "http://localhost:8080/api/inventorycontrol/entry_item/delete/{uuid}",
                                                 "message": "The Token has expired on Mon May 23 17:39:42 BRT 2022.",
                                                 "error": "Unauthorized",
                                                 "status": 401
                                            }
